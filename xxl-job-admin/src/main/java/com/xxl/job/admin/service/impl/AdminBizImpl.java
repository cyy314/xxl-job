...
public class AdminBizImpl implements AdminBiz {
	...
	public ReturnT<String> addJob(JobInfo jobInfo) {
		try {
			...
			ReturnT<String> addReturn = xxlJobService.add(xxlJobInfo);
			logger.info("addJob result:{}",addReturn.toString());
			return addReturn;
		} catch (Exception e) {
	...
	public ReturnT<String> removeJob(int jobId) {
		try {
			ReturnT<String> removeReturn = xxlJobService.remove(jobId);
			logger.info("removeJob result:{}",removeReturn.toString());
			return removeReturn;
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
	...
	public ReturnT<String> updateJob(JobInfo jobInfo) {
		try {
			XxlJobInfo xxlJobInfo = new XxlJobInfo();
			BeanUtils.copyProperties(jobInfo, xxlJobInfo);
			ReturnT<String> updateReturn = xxlJobService.update(xxlJobInfo);
			logger.info("updateJob result:{}",updateReturn.toString());
			return updateReturn;
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
	...
	public ReturnT<String> pauseJob(int jobId) {
		try {
			ReturnT<String> pauseReturn = xxlJobService.pause(jobId);
			logger.info("pauseJob result:{}",pauseReturn.toString());
			return pauseReturn;
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
	...
	public ReturnT<String> resumeJob(int jobId) {
		try {
			ReturnT<String> resumeReturn = xxlJobService.resume(jobId);
			logger.info("resumeJob result:{}",resumeReturn.toString());
			return resumeReturn;
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
